...
import com.pms.auth.model.AuthenticatedUser;
...
public class JwtVerifier {
    ...
    private static final String ROLE_NAME = Constants.ROLE_NAME;
    private static final String AUTHORITIES = Constants.AUTHORITIES;
    private static final String PERMISSIONS = Constants.PERMISSIONS;
